...
public final class CaptureActivity extends Activity implements
	...
	public void handleDecode(Result rawResult, Bitmap barcode) {
		...
		intent.putExtra("SCAN_RESULT", lastResult.toString());
	...
	private void handleDecodeExternally(Result rawResult, Bitmap barcode){
		...
		ResultHandler resultHandler = ResultHandlerFactory.makeResultHandler(
				this, rawResult);
		// statusView.setText("占쏙옙占쌘듸옙 占싸쏙옙 占싹뤄옙");
		if(copyToClipboard){
	...
	private void displayFrameworkBugMessageAndExit(){
		...
		// builder.setMessage("카占쌨띰옙 占싸식울옙 占쏙옙占쏙옙占쏙옙 占쌩삼옙占싹울옙占쏙옙占싹댐옙. 占쏙옙占쏙옙決占쏙옙占�占쏙옙占쏙옙占쏙옙臼占�占쌍십시울옙");
	...
	private void resetStatusView(){
		...
		// statusView.setText("占썹각占쏙옙 占쏙옙占쏙옙占쏙옙 占쏙옙占쌘드에 占쏙옙占쌩몌옙 占쌘듸옙占쏙옙占쏙옙 占싸쏙옙占쌌니댐옙");
